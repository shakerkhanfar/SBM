...
import { ConversationItem } from '@/features/call-history/types/call-history-list.types';
...
export default function CallHistoryPage() {
  ...
  const handleExportCurrentPage = async () => {
    ...
    const excelData = currentPageData.map((item: ConversationItem) => ({
      ...
      ['ID']: item.id,
      ['Agent Number']: item.callParams?.machineNumber || '',
      ['User Number']: item.callParams?.userNumber || '',
    }));
